            ...
            <section className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm space-y-6">
               ...
               <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div className="space-y-1.5">
                     ...
                     <input className="w-full bg-gray-50 border border-gray-100 rounded-xl px-4 py-2.5 text-sm font-bold focus:ring-2 focus:ring-[#006B5D]/10 outline-none transition-all" defaultValue="System" />
                  </div>
                  <div className="space-y-1.5">
                     <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest">
                  ...
                  <div className="space-y-1.5 sm:col-span-2">
                     ...
                     <input className="w-full bg-gray-50 border border-gray-100 rounded-xl px-4 py-2.5 text-sm font-bold" defaultValue="admin@cityvoice.gov.et" />
                  </div>
               </div>
            </section>
               ...
               <div className="space-y-6 max-w-md">
                  <div className="space-y-1.5">
                     ...
                     <div className="relative">
                        <input type={showPwd ? "text" : "password"} className="w-full bg-gray-50 border border-gray-100 rounded-xl px-4 py-2.5 text-sm font-bold" placeholder="••••••••" />
                  ...
                  <div className="space-y-1.5">
                     ...
                     <input type="password" className="w-full bg-gray-50 border border-gray-100 rounded-xl px-4 py-2.5 text-sm" placeholder={t('settings.security.placeholder_new')} />
                  </div>
                  <div className="space-y-1.5">
                     <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest">
                        {t('settings.security.confirm_password')}
                     </label>
                     <input type="password" className="w-full bg-gray-50 border border-gray-100 rounded-xl px-4 py-2.5 text-sm" placeholder={t('settings.security.placeholder_confirm')} />
                  </div>
               </div>
            </section>
